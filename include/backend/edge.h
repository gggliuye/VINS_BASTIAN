...
public:
    ...
    explicit Edge(int residual_dimension, int num_verticies,
                  const std::vector<VertexEdgeTypes> &verticies_types = std::vector<VertexEdgeTypes>());
...
protected:
    ...
    std::vector<VertexEdgeTypes> verticies_types_;       // info about all the edge for debug use
